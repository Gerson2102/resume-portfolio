...
function ExperienceCard({ experience }: ExperienceCardProps) {
  return (
    <article className="glass-card rounded-xl p-8 hover:shadow-lg transition-all duration-300">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* Company Info & Image */}
        <div className="lg:col-span-1 space-y-4">
          <div className="aspect-square max-w-48 mx-auto lg:mx-0 bg-neutral-100 dark:bg-neutral-700 rounded-xl overflow-hidden">
            {experience.images ? (
              <OptimizedImage
